...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Descargar el código ...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos a eliminar repo...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Eliminación de instancia/empresa ${empresa_delete} completado exitosamente...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a bloquear repo...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 bloqueo de empresa ${empresa_bloquear} realizado con exito ...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Desbloqueo de Instancia/Empresa ${empresa_desbloquear} realizado con exito ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Cambiemos los dominios de repo...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 cambio de dominio de Instancia/Empresa ${empresa_dominio} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
...
sudo su - root <<EOF
  ...
  # Agregar repositorio de PostgreSQL oficial
  echo "deb http://apt.postgresql.org/pub/repos/apt $(lsb_release -cs)-pgdg main" \
    > /etc/apt/sources.list.d/pgdg.list
  wget --quiet -O - https://www.postgresql.org/media/keys/ACCC4CF8.asc | apt-key add -

  # Actualizar paquetes e instalar PostgreSQL 12
  apt-get update -y
  ...
  # Variable de versión
  PG_VERSION="12"
  printf " ✅ PostgreSQL $PG_VERSION instalado exitosamente\n"
EOF
  sleep 2
}
#######################################
...
system_certbot_setup() {
  print_banner
  printf "${WHITE} 💻 Configurando certbot, estamos casi listo...${GRAY_LIGHT}"
  printf "\n\n"
